          ...
          <div className="about-content">
            ...
            >
              ...
              <p>
                ...
                후 SESAC 클라우드 기반 웹 개발자 교육과정에서 웹에 대한 공부를
                하였고, 관련 자격증들을 취득했습니다. 향후 많은 개발자들 분들과
                협업을 하고 싶고, 협업할 때 한 사람의 몫을 제대로 하면서 개발에
                기여하고 싶습니다. 능숙할 때에는 이끌 수 있고 부족할 때에는 배울
                수 있는 개발자가 되고 싶습니다.
              </p>
            </div>
            ...
            <div className="content" id="visions" ref={visionsElement}>
              ...
              <p>2. 클라우드 환경에서 개발을 숙달하고 싶습니다.</p>
              <p>3. 제 직무와 관련된 자격증을 취득하고 싶습니다.</p>
